...
class AppColor {
  ...
  static const Color orange = Color.fromARGB(255, 226, 158, 23);
  static const Color secondColor = Color.fromARGB(255, 14, 18, 36);
  static const Color primaryColor = Color.fromARGB(255, 19, 36, 62);
}
